...
main = Tk()
main.geometry("1280x680")      #1366x768
...
img = PhotoImage(file="./images/main.png")          #first landing page image
...
img2 = PhotoImage(file="./images/1.png")       #employee button
...
img3 = PhotoImage(file="./images/2.png")       #admin button
